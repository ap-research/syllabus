...
1. As a class, we will go over important ethical pratices in research, including the following:
    ...
    - IRB process for research involving human subjects **[CR2a]** \index{CR2a}
...
4. Use p. 77 of the Workbook as a reference to develop a brief elevator speech with an informal poster containing the following elements: **[CR5]** \index{CR5}
