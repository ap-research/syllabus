...
\item
  ...
  \item
    IRB process for research involving human subjects \textbf{{[}CR2a{]}} \index{CR2a}
  \item
...
\item
  Use p.~77 of the Workbook as a reference to develop a brief elevator speech with an informal poster containing the following elements: \textbf{{[}CR5{]}} \index{CR5}
